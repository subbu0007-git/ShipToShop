    ...
    const renderOrderItem = ({ item, index }) => (
        <Import.View
            style={{
                ...
                borderWidth: 1,
                marginTop: 8,
                marginBottom: index === orders?.length - 1 ? "38%" : 0,
        ...
        >
            ...
            >
                <Import.View>
                    <Import.Text style={Import.Theme.h1}>Order_ID</Import.Text>
                </Import.View>
                <Import.View>
                    <Import.Text style={[Import.Theme.h1, { color: "#3aa0d4" }]}>
                        {item?.order_id}
                    </Import.Text>
                </Import.View>
            </Import.View>
            ...
            >
                <Import.View>
                    <Import.Text style={Import.Theme.h1}>Total</Import.Text>
                </Import.View>
                <Import.View>
                    <Import.Text style={[Import.Theme.h1, { color: "#3aa0d4" }]}>
                        ₹{item?.total_amount}
            ...
            >
                <Import.Text style={[Import.Theme.h3, { color: "grey" }]}>
